#!/usr/bin/env python3
"""A basic Flask app with Flask Babel integration.
"""
from flask import Flask, render_template
from flask_babel import Babel

class Config:
    """Defines Flask Babel configuration settings.
    """
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=5000)  # Run the Flask app on specified host and port
